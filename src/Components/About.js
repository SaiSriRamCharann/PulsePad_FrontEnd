  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="bg-white shadow-2xl rounded-3xl p-8 max-w-sm w-full flex flex-col items-center text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Pindi Sai Sri Ram Charan</h1>
        ...
        <div className="space-y-4 w-full">
          ...
          <a
            href="mailto:saisriramcharanpindi@gmail.com"
            className="flex items-center gap-3 p-3 rounded-xl border border-gray-200 hover:bg-blue-50 transition-colors"
          >
            <span className="font-semibold text-gray-700 w-20 text-left">Email:</span>
            <span className="text-blue-600 break-words text-[15px]">saisriramcharanpindi@gmail.com</span>
          </a>

          <a
            href="https://github.com/SaiSriRamCharann"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 p-3 rounded-xl border border-gray-200 hover:bg-gray-100 transition-colors"
          >
            <span className="font-semibold text-gray-700 w-20 text-left">GitHub:</span>
            <img
          ...
          <a
            href="https://www.linkedin.com/in/sai-sri-ram-charan-pindi-58115b2a9/"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 p-3 rounded-xl border border-gray-200 hover:bg-blue-50 transition-colors"
          >
            <span className="font-semibold text-gray-700 w-20 text-left">LinkedIn:</span>
            <img
